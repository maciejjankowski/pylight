...
class DmxPy:
	def __init__(self, serialPort):
		try:
			...
			sys.exit(0)
		self.serial.write( str.encode(DMXOPEN+DMXINIT1+DMXCLOSE))
		self.serial.write( str.encode(DMXOPEN+DMXINIT2+DMXCLOSE))
	...
	def render(self):
		...
		self.serial.write(str.encode(DMXOPEN+DMXINTENSITY+sdata+DMXCLOSE))
